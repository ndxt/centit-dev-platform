...
public class EnvironmentExportController extends BaseController {
    ...
    @WrapUpResponseBody
    public void exportEnvironment(@PathVariable String osId, HttpServletRequest request) throws IOException {
        ...
        environmentExportManager.exportApplication(osId, ud);
    }
